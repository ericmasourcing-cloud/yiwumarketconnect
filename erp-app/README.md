...
一套可本机运行、可容器部署的外贸业务 ERP。覆盖客户、产品、供应商、多产品报价、销售合同、采购、出运、应收应付、资金、利润、月度分配、售后、审批、通知、附件和审计，并提供关联详情、版本保护修改、业务时间线、受控作废和多级审批。V1.9 新增客户、供应商、产品、报价、合同、采购、出运和审批的组合筛选与分页，以及按用户隔离的保存视图、默认视图、恢复和删除。
