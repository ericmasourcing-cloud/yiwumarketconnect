...
一套可本机运行、可容器部署的外贸业务 ERP。覆盖客户、产品、供应商、多产品报价、销售合同、采购、出运、应收应付、资金、利润、月度分配、售后、审批、通知、附件和审计，并提供关联详情、版本保护修改、业务时间线、受控作废和多级审批。V3.1 新增表单内快速建档：创建或修订 PI/SO 时可在原表单内快速建立供应商与产品，新产品自动加入当前产品选择并回填描述、售价、成本；新建或编辑产品时也可直接创建供应商并自动设为默认供应商，无需退出当前工作。
