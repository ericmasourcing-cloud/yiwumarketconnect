...
一套可本机运行、可容器部署的外贸业务 ERP。覆盖客户、产品、供应商、多产品报价、销售合同、采购、出运、应收应付、资金、利润、月度分配、售后、审批、通知、附件和审计，并提供关联详情、版本保护修改、业务时间线、受控作废和多级审批。V2.6 新增个人、部门、全公司三级数据范围：由服务端统一约束经营看板、客户、报价、合同、采购、出运、付款计划和附件访问，详情链接与附件下载也不能绕过；业务员不可切换至全公司范围。
