...
一套可本机运行、可容器部署的外贸业务 ERP。覆盖客户、产品、供应商、多产品报价、销售合同、采购、出运、应收应付、资金、利润、月度分配、售后、审批、通知、附件和审计，并提供关联详情、版本保护修改、业务时间线、受控作废和多级审批。V3.2 新增经营穿透：看板指标、客户漏斗、待办与最近合同均可进入对应业务明细；利润合同支持全部、未结束、待申请、结算中、已结算筛选；分成付款可按人员与业务月份汇总，并逐条穿透 SO、PS、应付、已付和未付。
