...
const testimonials = [
  {
    quote: "Eric helped me find a reliable toy supplier with a MOQ of just 100 pieces — way lower than what I found on Alibaba. He sent detailed photos of every product variation and even caught a color mismatch before shipment. I've now placed 3 repeat orders through him. Highly recommend for any small toy store owner.",
    name: 'Sarah K.',
  ...
  {
    quote: "I was skeptical about working with someone in China I'd never met. But Eric was incredibly responsive on WhatsApp, honest about pricing (he showed me what the supplier charged vs. his fee), and the samples he collected matched exactly what he described in his videos. He saved me a 15-hour flight to Yiwu. Worth every penny.",
    name: 'Marcus T.',
  ...
  {
    quote: "We needed custom gift boxes with our logo for our boutique shop. Eric handled the back-and-forth with the supplier for three rounds of mockups — sending me photos and videos at each stage. The final boxes looked exactly like the design I approved. He really takes care of the details that I would have missed.",
    name: 'Aiko N.',
  ...
  {
    quote: "As a first-time importer, I had no idea where to start. Eric walked me through the entire process — from finding pet product suppliers to understanding shipping costs. He replies to my WhatsApp messages within hours, even on weekends. After 6 months, he's become my go-to guy for anything China sourcing.",
    name: 'David R.',
    role: 'Pet Shop Owner',
    location: 'Australia',
    initials: 'DR',
