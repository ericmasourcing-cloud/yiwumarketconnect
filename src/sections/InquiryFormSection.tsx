...
export default function InquiryFormSection() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Create a hidden form and submit via POST (avoids CORS issues)
  ...
  return (
    <section id="contact" style={{ background: 'var(--beige)' }}>
      ...
      <iframe ref={iframeRef} name="form_iframe" style={{ display: 'none' }} title="form-iframe" />
          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
              <div>
                ...
                <input type="text" name="name" required placeholder="John Smith" value={formData.name} onChange={handleChange} className={inputClasses} style={inputStyle} />
              </div>
              ...
              <div>
                ...
                <input type="email" name="email" required placeholder="john@yourshop.com" value={formData.email} onChange={handleChange} className={inputClasses} style={inputStyle} />
              </div>
              ...
              <div>
                ...
                <input type="tel" name="whatsapp" placeholder="+31 6 1234 5678" value={formData.whatsapp} onChange={handleChange} className={inputClasses} style={inputStyle} />
              </div>
              ...
              <div>
                ...
                <select name="businessType" value={formData.businessType} onChange={handleChange} className={inputClasses} style={inputStyle}>
              ...
              <div>
                ...
                <textarea name="productDescription" required rows={5} placeholder="Describe the products you're looking for, including type, quantity, target price range, quality preferences, and any design or packaging requirements. You can also paste links to reference products." value={formData.productDescription} onChange={handleChange} className={inputClasses + " py-4 min-h-[140px] resize-y"} style={inputStyle} />
              </div>
              ...
              <div>
                ...
                <select name="orderVolume" value={formData.orderVolume} onChange={handleChange} className={inputClasses} style={inputStyle}>
              ...
              <div>
                ...
                <input type="text" name="shippingCountry" placeholder="e.g., Germany, USA, Australia" value={formData.shippingCountry} onChange={handleChange} className={inputClasses} style={inputStyle} />
              </div>
              ...
              <p className="font-body text-[13px] text-center" style={{ color: 'var(--navy-40)' }}>
